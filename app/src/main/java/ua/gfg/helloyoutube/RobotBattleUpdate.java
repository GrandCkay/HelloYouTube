...
class Solution {
    ...
    public static void doMove(AbstractRobot robotFirst, AbstractRobot robotSecond) {
        ...
        if (AbstractRobot.hitCountAttack == AbstractRobot.hitCountDefense) {
            ...
            System.out.println(String.format("%s(%sHP) атаковал робота %s(%sHP), удар в %s заблокирован",
            ...
            System.out.println(String.format("%s(%sHP) атаковал робота %s(%sHP), УДАР ПРОШЕЛ! Атакована %s, защищена %s, -%sHP у \"%s\"",
