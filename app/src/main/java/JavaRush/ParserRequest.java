...
public class ParserRequest {
    public static void main(String[] args) throws IOException {
        ...
        String stringURL = reader.readLine();       // http://javarush.ru/alpha/index.html?lvl=15&value&name=Amigo

        int indexURL = stringURL.indexOf("?") + 1;
        String lineValue = stringURL.substring(indexURL);      // lvl=15&value&name=Amigo
...
//        // 2
//        String lineValue = stringURL.substring(stringURL.lastIndexOf("?") + 1);     // lvl=15&value&name=Amigo
...
//        // 1
//        String[] stringsIndexNumber = new String[value.length];
//
//        for (int i = 0, j = 0; i < value.length; i++) {
//            if (value[i].contains("=")) {
//                int indexValue = value[i].indexOf("=");
//                if (indexValue > 0) {
//                    stringsIndexNumber[j] = value[i].substring(indexValue + 1);
//                    j++;
//                }
...
//                System.out.println();
//                try {
//                    alert(Double.parseDouble(stringsIndexNumber[0]));
//                } catch (Exception e) {
//                    alert(stringsIndexNumber[0]);
//                }
//            }
//        }
    }
